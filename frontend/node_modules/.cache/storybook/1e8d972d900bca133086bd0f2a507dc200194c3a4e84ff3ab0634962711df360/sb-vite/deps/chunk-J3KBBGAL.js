...
var LazySyntaxHighlighter = (0, import_react5.lazy)(async () => {
  const { SyntaxHighlighter: SyntaxHighlighter2 } = await import("./syntaxhighlighter-CAVLW7PM-66MVBZQV.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react5.lazy)(async () => {
  const [{ SyntaxHighlighter: SyntaxHighlighter2 }, { formatter }] = await Promise.all([
    import("./syntaxhighlighter-CAVLW7PM-66MVBZQV.js"),
    import("./formatter-OMEEQ6HG-DVLH2PNZ.js")
  ]);
  if (languages.length > 0) {
    languages.forEach((args) => {
      SyntaxHighlighter2.registerLanguage(...args);
...
var Code = __name(({
  ...
  return import_react4.default.createElement(
    StyledSyntaxHighlighter,
    {
      bordered: true,
      copyable: true,
      language: (language == null ? void 0 : language[1]) ?? "text",
      format: false,
      ...props
    },
    children
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = __name((props) => {
      ...
      const Context = ((_a = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a[index3]) || BaseContext;
      const value = React8.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime.jsx)(Context.Provider, { value, children });
    }, "Provider");
    Provider.displayName = rootComponentName + "Provider";
...
var LazyWithTooltip = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-EYOFUND7.js").then((mod) => ({ default: mod.WithTooltip }))
);
...
var LazyWithTooltipPure = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-EYOFUND7.js").then((mod) => ({ default: mod.WithTooltipPure }))
);
...
var Item2 = __name(({ id, onClick, ...rest }) => {
  ...
  const handleClick = (0, import_react34.useCallback)(
    (event) => onClick == null ? void 0 : onClick(event, { id, active, disabled, title, href }),
...
function useList(list) {
  ...
  const setTabLists = (0, import_react41.useCallback)(() => {
    ...
    const newInvisibleList = list.filter((item) => {
      ...
      const { width: tabWidth = 0 } = (tabButton == null ? void 0 : tabButton.getBoundingClientRect()) || {};
...
//# sourceMappingURL=chunk-J3KBBGAL.js.map
