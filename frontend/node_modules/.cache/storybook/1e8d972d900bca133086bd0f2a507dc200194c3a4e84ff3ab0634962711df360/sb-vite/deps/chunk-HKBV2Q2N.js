...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-J3KBBGAL.js";
import {
  ActionBar
} from "./chunk-5H3A42DY.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-D6LCSMC6.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  includeConditionalArg,
  require_channels
} from "./chunk-EATWL6AM.js";
import {
...
var Preview = __name(({
  ...
  const copyToClipboard = (0, import_react5.useCallback)(async (text) => {
    const { createCopyToClipboardFunction } = await import("./components-L52PCDND.js");
  ...
  const onCopyCapture = __name((e2) => {
    ...
    if (additionalActionItems.filter((item) => item.title === "Copied").length === 0) {
      copyToClipboard((source == null ? void 0 : source.props.code) ?? "").then(() => {
...
var BooleanControl = __name(({
  ...
  const readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
  if (value2 === void 0) {
...
var _JsonTree = class _JsonTree2 extends import_react29.Component {
  ...
  onUpdate(key, data) {
    var _a, _b;
    this.setState({ data });
    (_b = (_a = this.props).onFullyUpdate) == null ? void 0 : _b.call(_a, data);
  }
  removeRoot() {
...
var ObjectControl = __name(({ name, value: value2, onChange, argType }) => {
  ...
  const isObjectOrArray = Array.isArray(value2) || typeof value2 === "object" && (value2 == null ? void 0 : value2.constructor) === Object;
...
var TextControl = __name(({
  ...
  ), maxLength && import_react33.default.createElement(MaxLength, { isMaxed: (value2 == null ? void 0 : value2.length) === maxLength }, (value2 == null ? void 0 : value2.length) ?? 0, " / ", maxLength));
}, "TextControl");
...
var FilesControl = __name(({
  ...
  const readonly = (_a = argType == null ? void 0 : argType.control) == null ? void 0 : _a.readOnly;
...
var LazyColorControl = (0, import_react20.lazy)(() => import("./Color-64QXVMR3-DHY4ZRQW.js"));
...
var ArgControl = __name(({ row, arg, updateArgs, isHovered }) => {
  ...
  if (!control || control.disable) {
    const canBeSetup = (control == null ? void 0 : control.disable) !== true && ((_a = row == null ? void 0 : row.type) == null ? void 0 : _a.name) !== "function";
...
var ArgJsDoc = __name(({ tags }) => {
  ...
  }), hasDisplayableReturns && import_react35.default.createElement("tr", { key: "returns" }, import_react35.default.createElement("td", null, import_react35.default.createElement("code", null, "Returns")), import_react35.default.createElement("td", null, (_b = tags.returns) == null ? void 0 : _b.description)))));
}, "ArgJsDoc");
function uniq(arr) {
  return [...new Set(arr)];
}
...
var ArgTypes = __name((props) => {
  ...
  const argTypesParameters = ((_a = parameters == null ? void 0 : parameters.docs) == null ? void 0 : _a.argTypes) || {};
...
function useTransformCode(source, transform, storyContext) {
  ...
  const transformed = transform ? transform == null ? void 0 : transform(source, storyContext) : source;
...
var getStorySource = __name((storyId, args, sourceContext) => {
  ...
  const sourceMap = sources == null ? void 0 : sources[storyId];
  const source = (sourceMap == null ? void 0 : sourceMap[argsHash(args)]) || (sourceMap == null ? void 0 : sourceMap[UNKNOWN_ARGS_HASH]);
  return source || { code: "" };
}, "getStorySource");
var useCode = __name(({
  snippet,
  ...
  const sourceParameters = ((_a = parameters.docs) == null ? void 0 : _a.source) || {};
...
var useSourceProps = __name((props, docsContext, sourceContext) => {
  ...
  const sourceParameters = ((_b = (_a = story == null ? void 0 : story.parameters) == null ? void 0 : _a.docs) == null ? void 0 : _b.source) || {};
...
var Canvas = __name((props) => {
  ...
  const layout = props.layout ?? story.parameters.layout ?? ((_b = (_a = story.parameters.docs) == null ? void 0 : _a.canvas) == null ? void 0 : _b.layout) ?? "padded";
  const withToolbar = props.withToolbar ?? ((_d = (_c = story.parameters.docs) == null ? void 0 : _c.canvas) == null ? void 0 : _d.withToolbar) ?? false;
  const additionalActions = props.additionalActions ?? ((_f = (_e2 = story.parameters.docs) == null ? void 0 : _e2.canvas) == null ? void 0 : _f.additionalActions);
  const sourceState = props.sourceState ?? ((_h = (_g = story.parameters.docs) == null ? void 0 : _g.canvas) == null ? void 0 : _h.sourceState) ?? "hidden";
  const className = props.className ?? ((_j = (_i = story.parameters.docs) == null ? void 0 : _i.canvas) == null ? void 0 : _j.className);
  const inline = ((_k = props.story) == null ? void 0 : _k.inline) ?? ((_n = (_m = (_l = story.parameters) == null ? void 0 : _l.docs) == null ? void 0 : _m.story) == null ? void 0 : _n.inline) ?? false;
...
var Controls3 = __name((props) => {
  ...
  const controlsParameters = ((_a = parameters.docs) == null ? void 0 : _a.controls) || {};
...
var getDescriptionFromResolvedOf = __name((resolvedOf) => {
  ...
  switch (resolvedOf.type) {
    ...
    case "meta": {
      ...
      const metaDescription = (_d = (_c = parameters.docs) == null ? void 0 : _c.description) == null ? void 0 : _d.component;
      if (metaDescription) {
        return metaDescription;
      }
      return ((_f = (_e2 = parameters.docs) == null ? void 0 : _e2.extractComponentDescription) == null ? void 0 : _f.call(_e2, component, {
        component,
        parameters
      })) || null;
    }
...
var DocsContainer = __name(({
  ...
  try {
    ...
    toc = (_b = (_a = meta.preparedMeta.parameters) == null ? void 0 : _a.docs) == null ? void 0 : _b.toc;
  } catch (err) {
...
var DocsStory = __name(({
  ...
  var _a, _b;
  const { story } = useOf(of || "story", ["story"]);
  const withToolbar = ((_b = (_a = story.parameters.docs) == null ? void 0 : _a.canvas) == null ? void 0 : _b.withToolbar) ?? withToolbarProp;
...
var Stories = __name(({ title = "Stories", includePrimary = true }) => {
  ...
  const { stories: { filter } = { filter: void 0 } } = ((_a = projectAnnotations.parameters) == null ? void 0 : _a.docs) || {};
  if (filter) {
...
var Subtitle2 = __name((props) => {
  ...
  const { componentSubtitle, docs } = (preparedMeta == null ? void 0 : preparedMeta.parameters) || {};
  ...
  const content = children || (docs == null ? void 0 : docs.subtitle) || componentSubtitle;
...
var Title3 = __name((props) => {
  ...
  const content = children || extractTitle((preparedMeta == null ? void 0 : preparedMeta.title) || "");
...
//# sourceMappingURL=chunk-HKBV2Q2N.js.map
