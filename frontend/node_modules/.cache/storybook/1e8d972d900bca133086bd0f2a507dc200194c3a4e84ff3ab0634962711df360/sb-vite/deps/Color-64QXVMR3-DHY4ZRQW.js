...
var useColorInput = __name((initialValue, onChange) => {
  ...
  const updateValue = (0, import_react.useCallback)(
    (update) => {
      ...
      const v2 = (parsed == null ? void 0 : parsed.value) || update || "";
      setValue(v2);
      if (v2 === "") {
        setColor(void 0);
        onChange(void 0);
  ...
  const cycleColorSpace = (0, import_react.useCallback)(() => {
    ...
    const updatedValue = (color == null ? void 0 : color[nextSpace]) || "";
...
var usePresets = __name((presetColors, currentColor, colorSpace) => {
  const [selectedColors, setSelectedColors] = (0, import_react.useState)((currentColor == null ? void 0 : currentColor.valid) ? [currentColor] : []);
  (0, import_react.useEffect)(() => {
    ...
    PickerTooltip,
    {
      ...
      tooltip: import_react.default.createElement(TooltipContent, null, import_react.default.createElement(
        ...
        WithTooltip,
        {
          ...
          hasChrome: false,
          tooltip: import_react.default.createElement(Note, { note: (preset == null ? void 0 : preset.keyword) || (preset == null ? void 0 : preset.value) || "" })
        },
        import_react.default.createElement(
          Swatch,
          {
            value: (preset == null ? void 0 : preset[colorSpace]) || "",
...
//# sourceMappingURL=Color-64QXVMR3-DHY4ZRQW.js.map
